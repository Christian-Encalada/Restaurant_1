                ...
                children: [
                  data.resta.isEmpty
                      ...
                      : CardRestaurantes(
                          ...
                          height: 175,
                          onTap: () {
                            context.push("/detalleRestaurante",
                                extra: data.resta[0]);
                          },
                        ),
                  ...
                  SizedBox(
                    height:
                        data.resta.isEmpty ? 0 : (data.resta.length ~/ 2) * 185,
                    child: GridView.builder(
                      ...
                      gridDelegate:
                        ...
                        mainAxisSpacing:
                            5.0, // Espacio vertical entre los elementos
                        crossAxisSpacing:
                            5.0, // Espacio horizontal entre los elementos
...
save() {
  ...
  List<Map<String, dynamic>> dishes = [
    {
      ...
      "category_es": "Mariscos",
      "price": 10.99
    },
    {
      "name_en": "Mixed grill",
      "category_en": "Meat",
      "name_es": "Parrillada mixta",
      "category_es": "Carne",
      "price": 18.99
    },
    {
      "name_en": "Seafood rice",
      "category_en": "Rice",
      "name_es": "Arroz marinero",
      "category_es": "Arroz",
      "price": 12.99
    },
    {
      "name_en": "Garlic langostinos",
      "category_en": "Seafood",
      "name_es": "Langostinos al ajillo",
      "category_es": "Mariscos",
      "price": 14.99
    },
    {
      "name_en": "Grilled corvina",
      "category_en": "Fish",
      "name_es": "Corvina a la plancha",
      "category_es": "Pescado",
      "price": 16.99
    },
    {
      "name_en": "Encebollado soup",
      "category_en": "Soup",
      "name_es": "Encebollado",
      "category_es": "Sopa",
      "price": 8.99
    ...
    {
      "name_en": "Green plantain ball",
      "category_en": "Appetizer",
      "name_es": "Bolón de verde",
      "category_es": "Aperitivo",
      "price": 5.99
    },
    {
      "name_en": "Coconut fish stew",
      "category_en": "Seafood",
      "name_es": "Encocado de pescado",
      "category_es": "Mariscos",
      "price": 13.99
    },
    {
    ...
    {
      "name_en": "Fish sango soup",
      "category_en": "Soup",
      "name_es": "Sango de pescado",
      "category_es": "Sopa",
      "price": 9.99
    },
    {
      "name_en": "Plantain chips and green plantain",
      "category_en": "Appetizer",
      "name_es": "Chifles y patacones",
      "category_es": "Aperitivo",
      "price": 6.99
    },
    {
    ...
    {
      "name_en": "Rice with shells",
      "category_en": "Rice",
      "name_es": "Arroz con conchas",
      "category_es": "Arroz",
      "price": 10.99
    },
    {
      "name_en": "Tripe soup",
      "category_en": "Soup",
      "name_es": "Caldo de manguera",
      "category_es": "Sopa",
      "price": 7.99
    },
    {
      "name_en": "Coconut breaded shrimp",
      "category_en": "Seafood",
    ...
    {
      "name_en": "Mixed ceviche",
      "category_en": "Seafood",
      "name_es": "Ceviche mixto",
      "category_es": "Mariscos",
      "price": 13.99
    },
    {
      "name_en": "Rice with stewed beans",
      "category_en": "Rice",
      "name_es": "Arroz con menestra",
      "category_es": "Arroz",
      "price": 10.99
    },
    {
      "name_en": "Fish dumplings",
      "category_en": "Appetizer",
      "name_es": "Bollos de pescado",
      "category_es": "Aperitivo",
      "price": 6.99
    },
    {
      ...
      "category_en": "Soup",
      "name_es": "Sopa marinera",
      "category_es": "Sopa",
      "price": 9.99
    },
    {
      "name_en": "Plantain chips with hogao",
      "category_en": "Appetizer",
    ...
    {
      "name_en": "Garlic fish fillet",
      "category_en": "Fish",
      "name_es": "Filete de pescado al ajillo",
      "category_es": "Pescado",
      "price": 14.99
    },
    {
  ...
  for (var i = 0; i < nomRestaurantesES.length; i++) {
    ...
    final RestauranteModels es = RestauranteModels(
      ...
      descripcion:
          "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur felis ante, placerat id blandit vitae, dapibus id mi. Nam lacus magna, aliquam ut mattis ut, porttitor sed quam. Vivamus erat.",
      estado: true,
      imagen:
          'https://via.placeholder.com/640x480.png/a59090/000000?Text=640x480',
      mesas: List.generate(
        ranMesa,
        (index) {
    ...
    FirebaseDatabase.instance
        .ref()
        .child("Datos/restaurantes/es/$id")
        .set(es.toJson())
        .whenComplete(() {
      debugPrint("bien es");
      ...
      FirebaseDatabase.instance
          .ref()
          .child("Datos/restaurantes/en/$id")
          .set(en.toJson())
          .whenComplete(() {
        debugPrint("bien en");
